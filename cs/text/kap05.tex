...
\begin{tabular}{|c|c|c|c|c|c|}%
    \hline
    \bfseries Kombinace & \bfseries Deska 1 & \bfseries Deska 2 & \bfseries Deska 3 & \bfseries Deska 4 & \bfseries Průměr% specify table head
    \\\hline
    \csvreader[head to column names, separator=semicolon,
    late after line=\\,
    late after last line=\\\hline]
    {./tabulky/testSetting.csv}{}% use head of csv as column names
